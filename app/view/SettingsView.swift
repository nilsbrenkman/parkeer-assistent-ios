        ...
        Form {
            ...
            Section(header: SectionHeader(Lang.Login.login.localized())) {
                Toggle(Lang.Account.autoLogin.localized(), isOn: $autoLogin)
                    .padding(.vertical, Constants.padding.nano)
                    .onChange(of: autoLogin) { toggle, initial in
